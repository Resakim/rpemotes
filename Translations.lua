Config.Languages = {
    ...
    ['kr'] = { -- Korean
	['emotes'] = '~h~~p~ 이모트 🎬',
	['danceemotes'] = "~h~~p~ 🕺 댄스 이모트",
	['animalemotes'] = "~h~~p~ 🐩 동물 이모트",
	['propemotes'] = "~h~~p~ 📦 소품 이모트",
	['favoriteemotes'] = "~h~~y~ 🌟 즐겨찾기",
	['favoriteinfo'] = "즐겨찾기로 설정하려면 여기에서 이모트를 선택하세요.",
	['rfavorite'] = "즐겨찾기 재설정",
	['prop2info'] = "❓ 소품 이모티콘은 마지막에 위치할 수 있습니다.",
	['set'] = " (",
	['setboundemote'] = ") 를 이모트로 사용하시겠습니까?",
	['newsetemote'] = "~w~ 는 이제 바인딩된 이모트입니다. 사용하려면 ~g~CapsLock~w~ 을 누르세요.",
	['cancelemote'] = "~h~~r~ 이모트 취소 🚷",
	['cancelemoteinfo'] = "~r~X~w~ 현재 재생중인 이모트를 취소합니다.",
	['walkingstyles'] = "~h~~p~ 걷기 스타일 🚶🏻‍♂️",
	['resetdef'] = "~h~~y~ 기본값으로 재설정",
	['normalreset'] = "~h~~r~ 기본 (재설정)",
	['moods'] = "~h~~p~ 기분 😒",
	['infoupdate'] = "~h~~g~ 크레딧 🤝🏻",
	['infoupdateav'] = "정보 (업데이트 가능)",
	['infoupdateavtext'] = "업데이트가 가능합니다, 다음 링크에서 최신 버전을 받으십시오 ~y~https://github.com/TayMcKenzieNZ/rpemotes~w~",
	['suggestions'] = "제안이 필요한가요?",
	['suggestionsinfo'] = "~r~TayMcKenzieNZ~s~ 의 FiveM 포럼에서 /emote 제안을 받아보세요! ✉️",
	['notvaliddance'] = "유효한 댄스가 아닙니다.",
	['notvalidemote'] = "유효한 이모트가 아닙니다.",
	['nocancel'] = "취소할 이모트가 없습니다.",
	['maleonly'] = "이 이모트는 남성 전용입니다. 죄송합니다!",
	['emotemenucmd'] = "애니메이션 메뉴를 열려면 /emotemenu 명령어를 사용하십시오.",
	['shareemotes'] = "~h~~p~ 👫 공유 이모트",
	['shareemotesinfo'] = "이모트를 사용할 주변 사람을 초대합니다",
	['sharedanceemotes'] = "~h~~p~ 🕺 공유 댄스",
	['notvalidsharedemote'] = "유효한 공유 이모트가 아닙니다.",
	['sentrequestto'] = "다음 사람에게 요청을 보냈습니다 ~y~",
	['nobodyclose'] = "누구도 ~r~가까이~w~ 있지 않습니다.",
	['doyouwanna'] = "~y~Y~w~ 로 동의, ~r~L~w~ 로 거절 (~g~",
	['refuseemote'] = "이모트가 거부되었습니다.",
	['makenearby'] = "근처 유저에게 플레이하게 합니다",
	['useleafblower'] = "송풍기를 사용하려면 ~y~G~w~키를 누르세요",
	['camera'] = "카메라 플레시를 사용하려면 ~y~G~w~키를 누르세요",
	['makeitrain'] = "비를 내리게 하려면 ~y~G~w~키를 누르세요",
	['pee'] = "소변을 발사하려면 ~y~G~w~키를 누르세요",
	['spraychamp'] = "샴페인을 뿌리려면 ~y~G~w~키를 누르세요",
	['stun'] = "스턴건을 사용하려면 ~y~G~w~키를 누르세요",
	['smoke'] = "담배를 피우려면 ~y~G~w~키를 누르세요",
	['vape'] = "베이프를 하려면 ~y~G~w~키를 누르세요",
	['bound'] = "바운드 ",
	['to'] = "to",
	['currentlyboundemotes'] = " 현재 바이딩된 이모트:",
	['notvalidkey'] = "유효한 키가 아닙니다.",
	['keybinds'] = "🔢 키 바인딩",
	['keybindsinfo'] = "사용",
	['searchemotes'] = "~h~~y~ 🔍 이모트 검색",
	['searchinputtitle'] = "검색:",
	['searchmenudesc'] = "(%s 개의) 이모트 결과입니다'~r~%s~w~':",
	['searchnoresult'] = "검색에 대한 결과가 없습니다 '~r~%s~w~'.",
	['searchshifttofav'] = "즐겨찾기로 설정하려면 L-Shift 키를 누른상태에서 Enter 를 누르세요",
	['searchcantsetfav'] = "공유 이모트는 즐겨찾기로 설정할 수 없습니다.",
	['invalidvariation'] = "잘못된 텍스쳐 형태입니다. 유효한 선택은 다음과 같습니다: %s",
	['firework'] = "폭죽을 사용하려면 ~y~G~w~키를 누르세요",
	['poop'] = "배설하려면 ~y~G~w~키를 누르세요",
	['puke'] = "토하려면 ~y~G~w~키를 누르세요",
	['cut'] = "자르려면 ~y~G~w~키를 누르세요",
	['btn_select'] = "선택",
	['btn_back'] = "뒤로",
	['btn_switch'] = "이동",
	['btn_increment'] = "증가",
	['dead'] = "죽은 상태에서는 이모트를 사용할 수 없습니다",
	['swimming'] = "수영 중에는 이모트를 사용할 수 없습니다",
	['notvalidpet'] = "이런! 잘못된 ped 모델이 감지되었습니다 🐕!",
	['animaldisabled'] = "죄송합니다! 이 서버에서는 동물 이모트가 비활성화되어 있습니다.",
	['adultemotedisabled'] = "Bonk! 성인용 감정표현이 비활성화되어 있습니다. 🔞",
	['toggle_instructions'] = "설명 표시",
	['exit_binoculars'] = "쌍안경 나가기",
	['toggle_binoculars_vision'] = "쌍안경 시각모드 전환",
	['exit_news'] = "뉴스 카메라 종료",
	['toggle_news_vision'] = "뉴스 시각모드 전환",
	['edit_values_newscam'] = "Edit the news text",
	['not_in_a_vehicle'] = "차량 안에 있는 동안에는 이 애니메이션을 재생할 수 없습니다.",
	['in_a_vehicle'] = "이 애니메이션은 차량 안에 있는 동안에만 재생할 수 있습니다 🚷",
	['no_anim_crawling'] = "크롤링 중에는 애니메이션을 재생할 수 없습니다.",
	['no_anim_right_now'] = "지금은 애니메이션을 재생할 수 없습니다.",
    },
}
